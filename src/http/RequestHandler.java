...
//			os.write( "<h1>이 페이지가 잘 보이면 실습과제 SimpleHttpServer를 시작할 준비가 된 것입니다.</h1>".getBytes( "UTF-8" ) );
	...
	private void responseStaticResource(OutputStream os, String url, String protocol) throws IOException {
		...
		responseTransfer(os, protocol,"200 OK", file);
	}
	...
	private void response404Error(OutputStream os, String protocol) throws IOException{
		...
		responseTransfer(os, protocol, "400 Bad Request", file);
	}
	...
	private void responseTransfer(OutputStream os, String protocol, String responseType, File file) throws IOException, UnsupportedEncodingException {
		byte[] body = Files.readAllBytes(file.toPath());
		String mimeType = Files.probeContentType(file.toPath());
		
		// header 전송
		os.write( (protocol + responseType +"\r\n").getBytes( "UTF-8" ) );
